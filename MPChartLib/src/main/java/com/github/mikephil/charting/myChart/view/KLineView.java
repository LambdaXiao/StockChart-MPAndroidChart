...
import com.github.mikephil.charting.myChart.BarBottomMarkerView;
import com.github.mikephil.charting.myChart.CandleCombinedChart;
import com.github.mikephil.charting.myChart.CoupleChartGestureListener;
import com.github.mikephil.charting.myChart.KRightMarkerView;
import com.github.mikephil.charting.myChart.LeftMarkerView;
import com.github.mikephil.charting.myChart.MyCombinedChart;
import com.github.mikephil.charting.myChart.data.KLineData;
import com.github.mikephil.charting.myChart.enums.TimeType;
...
//        xAxisK.setAxisMinimum(0);
        ...
        //设置图表边距
        candleChart.setViewPortOffsets(CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 5), CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 15));
        barChart.setViewPortOffsets(CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 5), CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 15));

        //手势监听
        CoupleChartGestureListener gestureListenerCandle = new CoupleChartGestureListener(candleChart, new Chart[]{barChart});
        CoupleChartGestureListener gestureListenerBar = new CoupleChartGestureListener(barChart, new Chart[]{candleChart});
        candleChart.setOnChartGestureListener(gestureListenerCandle);
        barChart.setOnChartGestureListener(gestureListenerBar);
        gestureListenerCandle.setCoupleClick(new CoupleChartGestureListener.CoupleClick() {
            @Override
            public void singleClickListener() {
                doCandleChartSwitch();
            }
        });
        gestureListenerBar.setCoupleClick(new CoupleChartGestureListener.CoupleClick() {
            @Override
            public void singleClickListener() {
                doBarChartSwitch();
            }
...
//        float maxScale = calMaxScale(820, kLineData.getxVals().size());
