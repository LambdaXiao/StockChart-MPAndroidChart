...
import com.github.mikephil.charting.myChart.TimeBarChart;
import com.github.mikephil.charting.myChart.TimeLineChart;
import com.github.mikephil.charting.myChart.TimeRightMarkerView;
import com.github.mikephil.charting.myChart.TimeXAxis;
import com.github.mikephil.charting.myChart.data.KTimeData;
import com.github.mikephil.charting.myChart.model.CirclePositionTime;
import com.github.mikephil.charting.myChart.model.TimeDataModel;
...
public class OneDayView extends BaseView {
    ...
    private void initChart() {
        ...
        //设置图表偏移边距
        lineChart.setViewPortOffsets(CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 3), CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 15));
        barChart.setViewPortOffsets(CommonUtil.dip2px(mContext, 60), 0, CommonUtil.dip2px(mContext, 60), CommonUtil.dip2px(mContext, 15));
